...
execute if score @s[tag=!advisor,tag=!store,tag=!store2,tag=!replacing] player_num > @p[tag=turn] player_num as @e[tag=advisor,tag=!store2,scores={buildType=4}] if score @s player_num = @p[tag=turn] player_num as @p[tag=turn] run tellraw @s [{"text":"+1 Card (Thief)","color":"white"}]
execute if score @s[tag=!advisor,tag=!store,tag=!store2,tag=!replacing] player_num > @p[tag=turn] player_num as @e[tag=advisor,tag=!store2,scores={buildType=4}] if score @s player_num = @p[tag=turn] player_num as @p[tag=turn] run function ig:player/draw
...
execute if entity @s[tag=royal] as @e[tag=gems,scores={player_num=0}] run function ig:ent/gem/take
...
execute if entity @e[tag=replacing,tag=building] run execute as @e[tag=replacing,tag=building,limit=1] at @s run function ig:ent/building/break