...
#Shadow Cult effect
execute if entity @e[tag=seen_me,tag=action_build] if entity @s[scores={player_buy_build=10}] if entity @e[tag=advisor,tag=!store2,scores={buildType=1..},tag=built] run function game:player/effect/start_shadow_cult
