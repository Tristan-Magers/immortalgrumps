...
execute if entity @s[scores={buildType=8}] run summon villager ~ ~0.5 ~ {Tags:["adv_vis","new_adv_vis"],NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Age:-999999,VillagerData:{profession:"minecraft:farmer",type:"minecraft:savanna"}}
...
execute if entity @s[tag=store2,scores={buildCost=1}] run summon armor_stand ~ ~1.7 ~ {Tags:["text","newtext"],CustomNameVisible:1b,Small:1b,Marker:1b,Invisible:1b,CustomName:'{"text":"Cost 1","color":"dark_aqua"}'}
execute if entity @s[tag=store2,scores={buildCost=2}] run summon armor_stand ~ ~1.7 ~ {Tags:["text","newtext"],CustomNameVisible:1b,Small:1b,Marker:1b,Invisible:1b,CustomName:'{"text":"Cost 2","color":"dark_aqua"}'}
execute if entity @s[tag=store2,scores={buildCost=3}] run summon armor_stand ~ ~1.7 ~ {Tags:["text","newtext"],CustomNameVisible:1b,Small:1b,Marker:1b,Invisible:1b,CustomName:'{"text":"Cost 3","color":"dark_aqua"}'}
execute if entity @s[tag=store2,scores={buildCost=4}] run summon armor_stand ~ ~1.7 ~ {Tags:["text","newtext"],CustomNameVisible:1b,Small:1b,Marker:1b,Invisible:1b,CustomName:'{"text":"Cost 4","color":"dark_aqua"}'}
execute if entity @s[tag=store2,scores={buildCost=5}] run summon armor_stand ~ ~1.7 ~ {Tags:["text","newtext"],CustomNameVisible:1b,Small:1b,Marker:1b,Invisible:1b,CustomName:'{"text":"Cost 5","color":"dark_aqua"}'}
