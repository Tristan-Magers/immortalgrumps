...
execute if entity @e[tag=seen_me,tag=action_build] run function ig:player/unstore_cards
...
execute if entity @s[tag=cancel] run function ig:player/unstore_cards
execute if entity @s[tag=cancel] run tag @a remove removing
execute if entity @s[tag=cancel] run tag @s add select
execute if entity @s[tag=cancel] run function ig:player/check_actionable
