...
execute if entity @e[tag=selected,tag=right] run function ig:player/attack/find_right_rec
execute if entity @e[tag=selected,tag=left] run function ig:player/attack/find_left_rec
execute if entity @e[tag=selected,tag=center] run function ig:player/attack/find_center_rec
