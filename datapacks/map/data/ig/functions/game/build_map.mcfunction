...
#players
execute if score .player1 .game = .1 .num run function ig:game/start_player/1
execute if score .player2 .game = .1 .num run function ig:game/start_player/2
execute if score .player3 .game = .1 .num run function ig:game/start_player/3
execute if score .player4 .game = .1 .num run function ig:game/start_player/4
