...
execute if entity @s[tag=info,scores={buildType=3}] run summon armor_stand ~ ~1.7 ~ {Tags:["text","newtext","temptext"],CustomNameVisible:1b,Small:1b,Marker:1b,Invisible:1b,CustomName:'{"text":"Your buildings heal at start of your turn."}'}
execute if entity @s[tag=info,scores={buildType=4}] unless entity @e[tag=advisor,scores={buildType=4},distance=1..,tag=!store2] run summon armor_stand ~ ~1.8 ~ {Tags:["text","newtext","temptext"],CustomNameVisible:1b,Small:1b,Marker:1b,Invisible:1b,CustomName:'{"text":"Draw 2 cards when you attack"}'}
execute if entity @s[tag=info,scores={buildType=4}] unless entity @e[tag=advisor,scores={buildType=4},distance=1..,tag=!store2] run summon armor_stand ~ ~1.5 ~ {Tags:["text","newtext","temptext"],CustomNameVisible:1b,Small:1b,Marker:1b,Invisible:1b,CustomName:'{"text":"and break a building."}'}
...
execute if entity @s[tag=info,scores={buildType=10},tag=store2] run summon armor_stand ~ ~1.8 ~ {Tags:["text","newtext","temptext"],CustomNameVisible:1b,Small:1b,Marker:1b,Invisible:1b,CustomName:'{"text":"First thing you buy is free."}'}
...
execute if entity @s[tag=info,scores={buildType=10},tag=!store2] run summon armor_stand ~ ~1.7 ~ {Tags:["text","newtext","temptext"],CustomNameVisible:1b,Small:1b,Marker:1b,Invisible:1b,CustomName:'{"text":"First thing you buy is free."}'}
