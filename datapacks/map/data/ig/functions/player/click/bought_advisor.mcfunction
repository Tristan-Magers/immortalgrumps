...
function ig:player/check_actionable_place_adv

#Traitor placement
execute if entity @e[tag=building,tag=selected,tag=store2,scores={buildType=9}] run function ig:player/check_actionable_adv_all

execute as @e[tag=building,tag=selected,tag=store2,limit=1] at @s run function ig:ent/building/break
