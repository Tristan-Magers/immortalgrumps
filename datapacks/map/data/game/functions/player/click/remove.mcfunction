...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:barrier"}}] run tag @a remove removing
execute if entity @s[nbt={SelectedItem:{id:"minecraft:barrier"}}] run tag @s add select
execute if entity @s[nbt={SelectedItem:{id:"minecraft:barrier"}}] run function game:player/check_actionable
execute if entity @s[nbt={SelectedItem:{id:"minecraft:barrier"}}] run clear @s lime_dye
execute if entity @s[nbt={SelectedItem:{id:"minecraft:barrier"}}] run clear @s barrier
execute if entity @s[nbt={SelectedItem:{id:"minecraft:barrier"}}] run item replace entity @s hotbar.7 with lime_dye{CustomModelData:2,display:{Name:'[{"text":"END TURN","color":"dark_green","bold":true,"italic":false},{"text":"","color":"gray"}]',Lore:[]},HideFlags:32,type:8} 1
